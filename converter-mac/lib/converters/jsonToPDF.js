...
<head>
  ...
  <style>
    * { margin: 0; padding: 0; box-sizing: border-box; }
    body { font-family: -apple-system, BlinkMacSystemFont, 'SF Pro Display', 'Helvetica Neue', sans-serif; color: #333; line-height: 1.6; padding: 40px; background: #fff; }
    .container { max-width: 800px; margin: 0 auto; }
    .header { display: flex; justify-content: space-between; margin-bottom: 40px; border-bottom: 3px solid #0ea5e9; padding-bottom: 20px; }
    .header-left h1 { font-size: 32px; color: #0ea5e9; margin-bottom: 5px; }
    .header-right { text-align: right; }
    .header-right p { font-size: 24px; font-weight: 600; color: #0ea5e9; }
    ...
    th { background-color: #0ea5e9; color: white; font-weight: 600; padding: 12px 10px; text-align: left; font-size: 12px; text-transform: uppercase; }
    ...
    .totals-row.grand { border-top: 2px solid #0ea5e9; border-bottom: 2px solid #0ea5e9; margin-top: 10px; padding: 12px 0; }
    .totals-row.grand .label, .totals-row.grand .amount { font-size: 18px; font-weight: 700; color: #0ea5e9; }
